...
insert into pelicula values(1,"Pelicula de asentinato masivo en texas","Terror","Masacre Texas","Un hombre trastornado empieza una maasacre","youtube.com/ht");
insert into pelicula values(2,"Pelicula sobre lluvia de comida","Comedia","Lluvia","Un cientifico inventa un aparato que hace que llueva comida pero pierde el control","youtube.com/ht");
insert into pelicula values(3,"Pelicula sobre jugetes","Infantil","Toy Story","Los juguetes de Andy pueden hablar","youtube.com/ht");
insert into pelicula values(4,"Pelicula sobre un pez perdido","Infantil","Buscando","Nemo desaparece y su padre merlin tiene que buscarlo","youtube.com/ht");
insert into pelicula values(5,"Pelicula sobre Thor el dios del trueno","Accion","Thor","Thor regresa buscando venganza","Youtube.con/jh");
...
insert into horario values (1,"2022-12-12","5:20",2500.0,1);
insert into horario values (2,"2022-12-12","5:20",2500.0,2);
insert into horario values (3,"2022-12-12","5:20",2500.0,3);
insert into horario values (4,"2022-12-12","5:20",2500.0,4);
insert into horario values (5,"2022-12-12","5:20",2500.0,5);
